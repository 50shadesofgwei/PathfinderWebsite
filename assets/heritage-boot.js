(function () {
  var PAGE_BOOT = {
    ...
    "home": [
      ...
      {
        "id": "faraday",
        "image": "/images/heritage/faraday.jpg",
        "color": "#4b4b4b",
      ...
      {
        "id": "simarro",
        "image": "/images/heritage/Research.jpg",
        "color": "#69553e",
        "placement": "bottom-right",
        "text": "Dr Luis Simarro ran one of the first histology laboratories in Madrid where the nervous system was studied at the cellular level. New staining techniques made structures visible that had never been seen before, and colleagues gathered to learn the methods.\n\nHis laboratory helped launch Santiago Ram\u00f3n y Cajal, who would prove the brain consists of discrete cells, founding modern neuroscience. The spirit was entrepreneurial in the scientific sense: share techniques, train successors, build a field."
      },
      {
        "id": "steel-pour",
      ...
      {
        "id": "smokestacks",
        "image": "/images/heritage/SteelWorks1.jpg",
        "color": "#5c564b",
        "placement": "bottom-left",
        "text": "By the mid-nineteenth century, a hillside above any industrial town in Europe would show dozens of chimneys, each one a furnace, engine, or mill at work. Valleys filled with coal smoke because entrepreneurs kept betting on steam.\n\nThis was thermodynamics turned into enterprise: converting fuel into work at scale, town by town, across the continent."
      },
      {
        "id": "apprentice",
